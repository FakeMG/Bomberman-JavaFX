...
public class Animation {
  ...
  public static Animation doll_left = new Animation(Sprite.doll_left, PLAYER_DELAY, true);
  public static Animation doll_right = new Animation(Sprite.doll_right, PLAYER_DELAY, true);
  public static Animation doll_dead = new Animation(Sprite.doll_dead, PLAYER_DELAY, true);

  public static Animation minvo_left = new Animation(Sprite.minvo_left, PLAYER_DELAY, true);
